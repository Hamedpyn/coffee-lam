...
const Footer = () => {
  return (
    <footer className={`!px-5 ${styles.footer}`}>
      <main className="container flex-wrap">
        <section className={styles.descriptions}>
          <Image width={171} height={53} src="/images/logo_light.png" alt="" />
        ...
        <section>
          ...
          <Article
            ...
            img="/images/IMG_20230920_130854_091-qconsqrfwm7t626t2hckfjifv0kdd7cofsbfd1jcig.jpg"
        ...
        <div className={styles.licenses}>
          ...
          <Image src="/images/license3.png" width={85} height={85} alt="" />
